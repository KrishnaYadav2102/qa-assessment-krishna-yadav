...
export class OnboardingPopup extends BasePage {
    ...
    readonly popupContainer = this.page.locator('[data-testid="onboarding-card"]');
    readonly welcomeHeader = this.popupContainer.getByText('Welcome to GoTrade!');
    readonly getStartedButton: Locator = this.popupContainer.getByText('Get Started');
    ...
    async validatePopupContent() {
        ...
        await Asserts.assertTextContains(this.popupContainer, 'Welcome to GoTrade!');
